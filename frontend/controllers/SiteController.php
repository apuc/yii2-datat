...
class SiteController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        try {
            $itemParent = ItemFactory::createItem(ItemFactory::BY_BEHAVIOR);
            $itemChildren = ItemFactory::createItem(ItemFactory::BY_TRAIT);

            $itemParent->slug = 'itemParent';
            $itemParent->save();

            $itemChildren->slug = 'itemChildren';
            $itemChildren->save();

            $itemParent->setKeyValues(['age' => '30', 'height' => '2.18']);
